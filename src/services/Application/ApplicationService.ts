...
import { AnswerError, FormQuestion, validateAnswers } from "./answerValidation";
...
// The applicant's existing row for a role -- a draft to resume, or the
// submission they already sent. Null if they haven't started.
...
// Guards against editing something already submitted. Shared by save & submit.
const assertNotAlreadySubmitted = async (userId: string, roleId: string) => {
