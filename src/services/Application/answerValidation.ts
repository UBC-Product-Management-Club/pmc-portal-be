...
import { QuestionType } from "../../schema/v2/Application";

// A question as stored in the cycle's `general_questions` or a role's
// `questions` jsonb array. Kept as a structural interface (rather than the zod
// type) so this module stays a pure function over plain data.
export interface FormQuestion {
    ...
    // Only used for ordering when a form is assembled; irrelevant to validation.
